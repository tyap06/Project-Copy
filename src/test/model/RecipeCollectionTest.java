...
public class RecipeCollectionTest {
    ...
    void runBefore() {
        ...
        r2 = new Recipe("Spaghetti Sauce with Ground Beef", 8, Arrays.asList("1 pound of ground beef", "1 onion chopped", "4 cloves garlic, minced",
                "1 small green bell pepper, diced", "1 (28 ounce) can diced tomatoes", "1 (16 ounce) can tomato paste", "2 teaspoons dried oregano",
                "2 teaspoons dried basil", "1 teaspoon salt"), 15, 70, Arrays.asList("Combine ground beef, onion, garlic, and green pepper " +
                ...
                "and tomato paste into the pan. Season with oregano, basil, salt, and pepper. Simmer spaghetti sauce for 1 hour, stirring occasionally."), 0);
        r3 = new Recipe("Five-Ingredient Red Curry Chicken", 6, Arrays.asList("2 tablespoons coconut oil", "1 (16 ounce) package skinless, " +
                ...
                "½ (16 ounce) package dried rice stick vermicelli noodles"), 10, 20, Arrays.asList("Heat oil in a large skillet on high heat. " +
                ...
                "and let simmer until flavors are absorbed, about 5 minutes. Divide chicken and noodles among individual serving bowls."), 0);
